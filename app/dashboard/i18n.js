...
export const T = {
  no: {
    ...
    addPhotoLabel: 'A · Bilde av plagget', addPhotoHint: 'Klikk for å laste opp bilde',
    addReceiptLabel: 'B · Kvittering (valgfritt)', addReceiptHint: 'Klikk for å laste opp kvittering',
  ...
  en: {
    ...
    addPhotoLabel: 'A · Photo of the garment', addPhotoHint: 'Click to upload photo',
    addReceiptLabel: 'B · Receipt (optional)', addReceiptHint: 'Click to upload receipt',
